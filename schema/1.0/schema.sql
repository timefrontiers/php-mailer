-- Retained v1.0.9 schema, extracted verbatim from tag v1.0.9 / commit 7091e7d.
-- Purpose: let MigrationTest exercise the real v1.0 -> 1.1 upgrade path
-- rather than only proving idempotency against an already-1.1 database.
-- Do not edit. This is evidence, not a maintained schema.
